...
class MMD_PP(torch.nn.Module):
    def __init__(self, device, patch_size=3, sigma=0.06, strides=1, r=512, pool_size=32, pool_strides=16
                 , normalize_patch='channel_mean', pad_image=True, weights=None, batch_reduction='mean', local_patch_size=None, local_sigma=None):
        ...
        self.losses = torch.nn.ModuleList([
            ...
            PatchRBFLoss(patch_size=local_patch_size, sigma=local_sigma, pad_image=pad_image, device=device, batch_reduction=batch_reduction),
