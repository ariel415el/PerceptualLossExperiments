...
if __name__ == '__main__':
    images_dir = 'clusters/2_images/images'
    ...
    output_dir = images_dir + "_" + "#".join([x.name for x in creiterion.losses])

    img = optimize_for_mean(images, creiterion, output_dir, num_steps=1000, lr=0.001, batch_size=1)
